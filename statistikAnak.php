        ...
        <table class="table table-bordered" style="border: 1px solid transparent; margin:0px; padding:0px;">
            ...
            <tr class="font-Form-Input">
                <td style="padding: 0px; padding-top: 8px;">
                    ...
                    <a href="cetakGrafikStuntingBulanan.php" class="btn btn-sm btn-success mb-2" style="border-radius: 0px; border: 1px solid #EE3625; background-color: #EE3625;" target="blank()"><img src="img/icon/pdfFormat.png" alt="" class="iconTable" style="margin-right: 5px;">Cetak Grafik Bulanan </a>
