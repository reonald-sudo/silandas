...
$jumlahDataTampil = 6;
$jumlahData = count(query("SELECT * FROM kia_anak"));
$jumlahHalaman = ceil($jumlahData / $jumlahDataTampil);
$halamanAktif = (isset($_GET["page"])) ? $_GET["page"] : 1;
$awalData = ($jumlahDataTampil * $halamanAktif) - $jumlahDataTampil;

$kiaAnak = query("SELECT * FROM kia_anak LIMIT $awalData,$jumlahDataTampil");
...
<body style="background-color: #F8F9FA;">
    ...
    <h3 align="center" class="font-Form" style="color:#4A5568; padding: 8px 0 0 0;">Data KIA Anak Desa Sungai Landas</h3>
    ...
    <div class="container" style="margin-bottom: 10px;">
            ...
            <table class="table table-bordered" style="border: 1px solid transparent; margin:0px; padding:0px;">
                <tr class="font-Form">
                    <td style="padding: 0px; padding-top: 8px;">
                        <a href="tambahKiaAnak.php" class="btn btn-sm btn-success mb-2" style="border-radius: 0px; border: 1px solid #006b65; background-color: #006b65;"><img src="img/icon/plus-sign.png" alt="" class="iconTable" style="margin-right: 5px;">Tambah Data </a>

                        <a href="excelKiaAnak.php" class="btn btn-sm btn-secondary mb-2" style="border-radius: 0px; background-color: #009868; border: 1px solid #009868;" target="blank"><img src="img/icon/xlsx-file-format-extension.png" alt="" class="iconTable" style="margin-right: 5px;">Unduh Data Xlsx</a>

                        <a href="cetakRekapKiaAnak.php" class="btn btn-sm btn-secondary mb-2" style="border-radius: 0px; background-color: #ee3625; border: 1px solid #ee3625;" target="blank"><img src="img/icon/pdfFormat.png" alt="" class="iconTable" style="margin-right: 5px;">Unduh Data Pdf</a>
        ...
        <div id="tabel_kia_anak">
            <table class="table table-sm table-bordered table-striped mb-3" style="border: 1px solid black; margin:0px;" cellspacing="0" cellpadding="5">
                <thead style="background-color: #006b65; color: white; font-size: 17px;" class="font-Form">
                    <tr align="center">
                        <th style="width: 3%; ">No</th>
                        <th style="width: 13%; ">No Register (KIA)</th>
                        <th style="width: 10%;">Nama Anak</th>
                        <th style="width: 12%; ">Nik Anak</th>
                ...
                <?php foreach ($kiaAnak as $row) : ?>
                    <tr align="center" class="font-Form-Input">
                        ...
                        <td><?= $row["kabupaten"] ?></td>
                        <td>
                            <a href="hapusKiaAnak.php?id= <?= $row["id_kia"] ?>" class="btn btn-sm btn-danger hapus" style="border-radius: 0px; border: 1px #dc3545;"><img src="img/icon/trashWhite.png" alt="" class="iconTable2"></a>

                            <a href="editKiaAnak.php?id= <?= $row["id_kia"] ?>" class="btn btn-sm btn-warning" style="border-radius: 0px; background-color: #FF9300; color: white; border: #FF9300;" id="buttonEdit">
