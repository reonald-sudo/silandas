...
$cetakRekapKiaHamil = query("SELECT * FROM kia_hamil");
...
<body>
  <div class="container-fluid";>
    ...
    <h4 align="center" style="margin: 0px; padding:0px;"><b><u>FORMULIR REKAPITULASI BUKU KIA IBU</u></b></h4>
        <p align="center" style="margin: 0px; padding:0px; font-size:12px;">Nomor : 011/SUNGAI-LANDAS/A.1/IX/2022
        </p>
    <br>';
...
$html .= '<table class="table table-sm table-bordered table-striped mb-3" style="border: 1px solid black; margin:0px;" cellspacing="0" cellpadding="5">
    <thead style="background-color: #15ADA7;">
        <tr align="center">
            ...
            <th style="width: 14%; border: 1px solid black;">KIA</th>
            <th style="width: 14%; border: 1px solid black;">Nama</th>
            <th style="width: 14%; border: 1px solid black;">Nik</th>
            <th style="width: 14%; border: 1px solid black;">Umur</th>
            <th style="width: 14%; border: 1px solid black; word-wrap: break-word;">Tanggal Buku</th>
            <th style="width: 14%; border: 1px solid black; word-wrap: break-word;">Kabupaten</th>    
        </tr>
    </thead>
';

$i = 1;
foreach ($cetakRekapKiaHamil as $row) :
    ...
    $html .= '<td  style="border: 1px solid black;" align="center">' . $row['nik'] . '</td>';
