...
$id_kia = $_GET["id_kia"];
$data = cetakStuntingGrafikBulanan("SELECT * FROM grafik_perorangan_stunting WHERE id_kia=$id_kia");
...
$html .= '</tr>
    <tr>
        <td>Nama Lengkap</td>
        <td>:</td>';
$html .= '<td><b>' . $data["nama"] . '</b></td>';

$html .= '</tr>
    <tr>
        <td>Jenis Kelamin</td>
        <td>:</td>';
$html .= '<td>' . $data["jenis_kelamin"] . '</td></tr></table>';
