    ...
    <div class="row no-gutter mt-5">
        ...
        <div class="col-md-2 pr-3 mt-2 pt-3" style="background-color: #406882;">
            <ul class=" nav flex-column mb-5" style="margin-left: 10px;">
                ...
                <li class="nav-item">
                    <a class="nav-link active text-white" href="dashboardDokter.php"><img src="img/icon/home-white.png" alt="" style="width: 24px; height: 24px; margin-bottom: 5px; margin-right: 5px;"> Home</a>
                </li>
                ...
                <li class="nav-item" style="padding-bottom: 150px;">
                    <a class="nav-link active text-white" href="kpmResikoDokterAnak.php"><img src="img/icon/heart-checkup-white.png" alt="" style="width: 24px; height: 24px; margin-bottom: 5px; margin-right: 5px;"> KPM Resiko Anak</a>
                </li>
                ...
                <li class="nav-item" style="padding-top: 0px;">
                    <hr class="bg-light mr-5">
                    <a class="nav-link text-white" href="logout.php"><img src="img/icon/exit-white.png" alt="" style="width: 24px; height: 24px; margin-bottom: 0px; margin-right: 5px;"> Logout</a>
                </li>
            </ul>
        </div>
        ...
        <div class="col-md-10 pt-4 p-4 mt-3" style="background-color: #f8f9fa;">
            <h3 class="heading-Page">
                <marquee direction="left" scrollamount="2" behavior="alternate"> SiLandas | Dokter - Home </marquee>
                <br style="margin-bottom: 1px;">
                <hr>
            </h3>

            <!-- banner slider -->
            <div id="carouselExampleCaptions" style="width: 100%; position: relative; padding-left: 4px;" class="carousel container slide data-bs-ride=" false">
