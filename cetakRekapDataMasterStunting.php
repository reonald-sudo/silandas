...
$cetakRekapStuntingMaster = query("SELECT * FROM rekap_stunting_$tahun");
...
<body>
  <div class="container-fluid";>
    ...
    <h4 align="center" style="margin: 0px; padding:0px;"><b><u>REKAPITULASI HASIL PEMANTAUAN TAHUNAN BAGI ANAK 0-2 TAHUN</u></b></h4>
...
$html .= '<table class="table table-sm table-bordered table-striped mb-3" style="border: 1px solid black; margin:0px;" cellspacing="0" cellpadding="5">
    <thead style="background-color: #15ADA7;">
        <tr align="center">
            ...
            <th style="width: 5%; border: 1px solid black;">Berat Badan</th>
            <th style="width: 5%; border: 1px solid black; word-wrap: break-word;">Tinggi Badan</th>
            <th style="width: 5%; border: 1px solid black; word-wrap: break-word;">Status Gizi</th>
...
$i = 1;
foreach ($cetakRekapStuntingMaster as $row) :
    ...
    $html .= '<td  style="border: 1px solid black;" align="center">' . $row['berat_badan'] . " " . "Kg" . '</td>';
    $html .= '<td  style="border: 1px solid black;" align="center">' . $row['tinggi_badan'] . " " . "Cm" . '</td>';
