...
<body>
    ...
    <h3 align="center" class="font-Form" style="color:#4A5568; padding: 8px 0 0 0;">Form Tambah Data KIA Ibu Desa Sungai Landas</h3>
    ...
    <div class="container mb-3">
        <form action="" method="post" style="margin: 0px;" enctype="multipart/form-data">
            ...
            <div style="border: 1px solid #F0F0F0; border-radius: 8px;" class="mb-3">
                ...
                <div style="background-color: #4A7E92; border:1px solid #4A7E92; padding:5px" class="mb-3">
                    <p class="font-Form" style="margin-top:12px; color:white" align="center">Menu Utama Tambah Data KIA Ibu</p>
                </div>
                        ...
                        <div style="background-color: white; border-radius: 5px;" class="mb-2">
                            ...
                            <table class="table mb-2" style="border: 1px transparent; margin:0px;" cellspacing="0" cellpading="0">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="nama" id="nama" class="form-control" required autofocus autocomplete="off"></td>
                                </tr>
                                <!-- NIK IBU -->
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="umur_ibu" id="umur_ibu" class="form-control" required autofocus autocomplete="off" placeholder="*Dalam Tahun"></td>
                                </tr>
                                <!-- TANGGAL BUKU -->
                                <tr>
    ...
    <script>
        $('.batal_kia_ibu').on('click', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.location.href = 'tambahKiaIbu.php';
                }
            })
        });
    </script>
