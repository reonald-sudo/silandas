    ...
    <div class="row no-gutter mt-5">
        ...
        <div class="col-md-10 pt-4 p-4 mt-2" style="background-color: #f8f9fa;">
            <h3 class="heading-Page">
                <img src="img/icon/user_black.png" alt="" style="width: 27px; height: 27px; margin-bottom: 5px; margin-right: 5px;"> DATA USER > TAMBAH USER
            ...
            <form action="" method="POST">
                <table class="table table-sm table-bordered mb-2" style="margin:0px; padding: 0px; border: 1px solid transparent;">
                    ...
                    <td style="width: 14.8%; padding: 0px; margin: 0px;">
                        <a href="user.php" class="btn btn-primary font-Form-Input" style="border-radius: 0px; "><img src="img/icon/left-arrow.png" class="iconTable" style="margin-right: 5px;" alt="">
                            Kembali
                        </a>
                    </td>
                    </tr>
                ...
                <div class="container shadow-Tambah-User">
                    ...
                    <div class="mb-3 row mt-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control mt-3 font-Form-Input" name="username" id="username">
                        </div>
                    </div>
                    <!-- email -->
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control font-Form-Input" name="email" id="email">
                        </div>
                    </div>
                    <!-- hak akses -->
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <select class="form-select font-Form-Input" id="akses" name="akses" required>
                                ...
                                <option value="pambakal">Pambakal</option>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <input type="password" class="form-control font-Form-Input" name="password" id="password">
                        </div>
                    </div>
                    <!-- konfirmasi password -->
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <input type="password" name="confirm_password" id="confirm_password" class="form-control font-Form-Input" id="inputPassword">
                        </div>
                    </div>
                    ...
                    <div class="mt-2" style="border: 1px solid transparent; width: 100%; padding-left: 0px; padding: 0px;">
                        <table class="table table-sm table-bordered mb-2" style="margin:0px; padding: 0px; border: 1px solid transparent;">
                            ...
                            <td style="width: 14.8%; padding: 0px; margin: 0px;">
                                ...
                                <a href="tambahUser.php" type="batal" id="batal" name="batal" class="btn btn-danger batal" style="border-radius: 0px; right: 10px;"><img src="img/icon/trashWhite.png" class="iconTable" style="margin-right: 5px;" alt="">
                                    Batal
                                </a>
                            </td>
                            </tr>
