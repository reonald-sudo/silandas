...
<body>
    ...
    <h3 align="center" class="font-Form" style="color:#4A5568; padding: 8px 0 0 0;">Form Edit Data KIA Anak Desa Sungai Landas</h3>
    ...
    <div class="container mb-3">
        <form action="" method="post" style="margin: 0px;">
            ...
            <div style="border: 1px solid #F0F0F0; border-radius: 8px;" class="mb-3">
                ...
                <div style="background-color: #FF9300; border:1px solid #FF9300; padding:5px" class="mb-3">
                    <p class="font-Form" style="margin-top:12px; color:white" align="center">Menu Utama Edit Data KIA Anak</p>
                </div>
                ...
                <div class="row gx-1 gy-3 mb-3">
                    ...
                    <div class="col-sm-3 batal_kia_anak" align="center">
                        <a href="editKiaAnak.php?id=<?= $editKiaAnak["id_kia"] ?>" style="border: 1px solid #E0E0E0; display:block; width:150px; height:80px; border-radius: 5px; box-shadow: 1px 1px 3px #ccc;" class="noUnderline btn">
                        ...
                        <div style="background-color: white; border-radius: 5px;" class="mb-2">
                            ...
                            <table class="table mb-2 font-Form-Input" style="border: 1px transparent; margin:0px;" cellspacing="0" cellpading="0">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="kia" id="kia" class="form-control" required autofocus autocomplete="off" value="<?= $editKiaAnak["id_kia"] ?>"></td>
                                </tr>
                                <!-- NAMA ANAK -->
                                <tr>
                                    <td><label for="nama" style="margin-top: 5px;">Nama Anak</label></td>
                                    <td><input type="text" name="nama_anak" id="nama_anak" class="form-control" required autofocus autocomplete="off" value="<?= $editKiaAnak["nama_anak"] ?>"></td>
                                </tr>
                                <!-- NIK ANAK -->
                                <tr>
                                    <td><label for="nama" style="margin-top: 5px;">Nik Anak</label></td>
                                    <td><input type="text" name="nik_anak" id="nik_anak" class="form-control" required autofocus autocomplete="off" value="<?= $editKiaAnak["nik_anak"] ?>"></td>
                                </tr>
                                <!-- NAMA IBU -->
                                <tr>
                                    <td><label for="nama" style="margin-top: 5px;">Nama Ibu</label></td>
                                    <td><input type="text" name="nama_ibu" id="nama_ibu" class="form-control" required autofocus autocomplete="off" value="<?= $editKiaAnak["nama_ibu"] ?>"></td>
                                </tr>
                                <!-- NIK IBU -->
                                <tr>
                                    <td><label for="nama" style="margin-top: 5px;">NIK Ibu</label></td>
                                    <td><input type="text" name="nik_ibu" id="nik_ibu" class="form-control" required autofocus autocomplete="off" value="<?= $editKiaAnak["nik_ibu"] ?>"></td>
                                </tr>
                                <!-- TANGGAL BUKU -->
                                <tr>
                                    <td><label for="nama" style="margin-top: 5px;">Tanggal Buku</label></td>
                                    <td><input type="date" name="tanggal_buku" id="tanggal_buku" class="form-control" required autofocus autocomplete="off" value="<?= $editKiaAnak["tanggal_buku"] ?>"></td>
                                </tr>
                                <!-- KABUPATEN -->
                                <tr>
                                    <td><label for="nama" style="margin-top: 5px;">Kabupaten</label></td>
                                    <td><input type="text" name="kabupaten" id="kabupaten" class="form-control" required autofocus autocomplete="off" value="<?= $editKiaAnak["kabupaten"] ?>"></td>
                                </tr>
                            </table>
                        </div>
                    </div>
    ...
    <script>
        $('.batal_kia_anak').on('click', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.location.href = 'editKiaAnak.php?id=<?= $id ?>';
                }
            })
        });
    </script>
