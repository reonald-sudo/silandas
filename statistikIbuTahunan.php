...
$jumlahDataTampil = 6;
$jumlahData = count(query("SELECT * FROM rekap_hamil_$tahun"));
...
<body style="background-color: #F8F9FA;">
        ...
        <table class="table table-bordered" style="border: 1px solid transparent; margin:0px; padding:0px;">
            ...
            <tr class="font-Form-Input">
                <td style="padding: 0px; padding-top: 8px;">
                    ...
                    <a href="cetakGrafikHamilTahunan.php" class="btn btn-sm btn-success mb-2" style="border-radius: 0px; border: 1px solid #EE3625; background-color: #EE3625;" target="blank()"><img src="img/icon/pdfFormat.png" alt="" class="iconTable" style="margin-right: 5px;">Cetak Grafik Tahunan </a>
    ...
    <script>
        ...
        const data = {
            ...
            datasets: [{
                label: 'Total Data',
                data: [<?= $jumlahData ?>, <?= $jumlahData2023 ?>, <?= $jumlahData2024 ?>, <?= $jumlahData2025 ?>],
                backgroundColor: [
                    'rgba(255, 99, 132, 0.2)',
                    'rgba(255, 159, 64, 0.2)',
                    'rgba(255, 205, 86, 0.2)',
