...
$petugas = query("SELECT * FROM petugas LIMIT $awalData,$jumlahDataTampil");
    ...
    <div class="row no-gutter mt-5">
        ...
        <div class="col-md-10 pt-4 p-4 mt-2" style="background-color: #f8f9fa;">
            <h3 class="heading-Page">
                <img src="img/icon/identity-card.png" alt="" style="width: 27px; height: 27px; margin-bottom: 5px; margin-right: 5px;"> DATA PETUGAS
                ...
                <table class="table table-bordered" style="border: 1px solid transparent; margin:0px; padding:0px;">
                    <tr>
                        <td style="padding: 0px; padding-top: 8px;">
                            <a href="tambahPegawai.php" class="btn btn-success mb-2 font-Form-Input" style="border-radius: 0px; border: 1px solid #1A374D; background-color: #1A374D;"><img src="img/icon/plus-sign.png" alt="" class="iconTable" style="margin-right: 5px; height: 12px; width: 12px;">Tambah Data</a>
                        </td>
                        <td style="width: 19%; padding: 0px; padding-top: 8px;">
                            <input type="text" name="keyword" class="form-control ds-input" placeholder="Cari data..." style="display: inline; font-family: 'Manrope', sans-serif; width: 80%; border-radius: 0px;" autocomplete="off" id="keyword">
