...
<head>
    ...
    <title>SiLandas Edit Data KIA Anak</title>
...
<body>
    ...
    <h3 align="center" class="font-Form" style="color:#4A5568; padding: 8px 0 0 0;">Form Ubah Data KIA Ibu Desa Sungai Landas</h3>
    ...
    <div class="container mb-3">
        <form action="" method="post" style="margin: 0px;" enctype="multipart/form-data">
            ...
            <div style="border: 1px solid #F0F0F0; border-radius: 8px;" class="mb-3">
                ...
                <div style="background-color: #FF9300; border:1px solid #FF9300; padding:5px" class="mb-3 font-Form">
                    <p style="margin-top:12px; color:white" align="center">Menu Utama Ubah Data KIA Ibu</p>
                </div>

                <div class="row gx-1 gy-3 mb-3 font-Form-Input">
                    ...
                    <div class="col-sm-3" align="center">
                        <button type="submit" class="btn" name="submit" style="border: 1px solid #F0F0F0; margin: 0px; padding: 0px 30px; box-shadow: 1px 1px 3px #ccc;">
                            ...
                            <p style="margin-bottom:10px;">Simpan Data</p>
                        </button>
                    </div>


                    <div class="col-sm-3 batal_kia_ibu" align="center"">
                        <a href=" tambahKiaIbu.php" style="border: 1px solid #E0E0E0; display:block; width:150px; height:80px; border-radius: 5px; box-shadow: 1px 1px 3px #ccc;" class="noUnderline btn">
                    ...
                    <div class="col-sm-3" align="center" id="tombol_kembali">
                        <a href="kiaIbu.php" style="border: 1px solid #E0E0E0; display:block; width:150px; height:80px; border-radius: 5px; box-shadow: 1px 1px 3px #ccc;" class="noUnderline btn">
                ...
                <div class="col-sm-5">
                    <div style="border:1px solid transparent;">
                        <div style="background-color: white; border-radius: 5px;" class="mb-2">
                            <img src="img/kia ibu.jpg" style="width: 450px; height: 394px;" alt="">
                        </div>
                    </div>
                </div>
                    ...
                    <div style="border:1px solid #F0F0F0; border-radius: 5px;">
                        ...
                        <div style="background-color: white; border-radius: 5px;" class="mb-2">
                            ...
                            <table class="table mb-2" style="border: 1px transparent; margin:0px;" cellspacing="0" cellpading="0">
                                ...
                                <!-- KIA -->
                                <tr>
                                    <td style="width: 25%;"><label for="nik" style="margin-top: 5px;">No Register (KIA) </label></td>
                                    <td><input type="text" name="kia" id="kia" class="form-control" required autofocus autocomplete="off" value="<?= $editKiaIbu["id_kia"] ?>"></td>
                                </tr>
                                <!-- NAMA IBU -->
                                <tr>
                                    <td><label for="nama" style="margin-top: 5px;">Nama Ibu</label></td>
                                    <td><input type="text" name="nama" id="nama" class="form-control" required autofocus autocomplete="off" value="<?= $editKiaIbu["nama"] ?>"></td>
                                </tr>
                                <!-- NIK IBU -->
                                <tr>
                                    <td><label for="nama" style="margin-top: 5px;">Nik Ibu</label></td>
                                    <td><input type="text" name="nik_ibu" id="nik_ibu" class="form-control" required autofocus autocomplete="off" value="<?= $editKiaIbu["nik"] ?>"></td>
                                </tr>
                                <!-- UMUR IBU -->
                                <tr>
                                    <td><label for="umur" style="margin-top: 5px;">Umur Ibu</label></td>
                                    <td><input type="text" name="umur_ibu" id="umur_ibu" class="form-control" required autofocus autocomplete="off" placeholder="*Dalam Tahun" value="<?= $editKiaIbu["umur"] ?>"></td>
                                </tr>
                                <!-- TANGGAL BUKU -->
                                <tr>
                                    <td><label for="nama" style="margin-top: 5px;">Tanggal Buku</label></td>
                                    <td><input type="date" name="tanggal_buku" id="tanggal_buku" class="form-control" required autofocus autocomplete="off" value="<?= $editKiaIbu["tanggal_buku"] ?>"></td>
                                </tr>
                                <!-- KABUPATEN -->
                                <tr>
                                    <td><label for="nama" style="margin-top: 5px;">Kabupaten</label></td>
                                    <td><input type="text" name="kabupaten" id="kabupaten" class="form-control" required autofocus autocomplete="off" value="<?= $editKiaIbu["kabupaten"] ?>"></td>
                                </tr>
    ...
    <script>
        $('.batal_kia_ibu').on('click', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.location.href = 'editKiaIbu.php?id=<?= $id ?>';
                }
            })
        });
    </script>
