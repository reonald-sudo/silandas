...
$dbMasterStunting = queryMaster("SELECT * FROM grafik_perorangan_stunting ORDER BY nama ASC LIMIT $awalData,$jumlahDataTampil");
...
<body style="background-color: #F8F9FA;">
    ...
    <div id="tabel_rekap_stunting" class="container">
        <div style="display: inline-block; width: 100%; background-color: #EBECED; border: 1px solid black;">
            <center>
                <h5 style="font-size: 25px; font-family: 'Manrope', sans-serif; margin-top: 5px;" class="font-Form">Data Statistik Anak Tahun <?= $tahun ?></h5>
            </center>
        </div>
            ...
            <?php foreach ($dbMasterStunting as $row) : ?>
                <tr align="center" class="font-Form-Input">
                    ...
                    <td style="font-family: 'Manrope', sans-serif;">
                        <a href="statistikAnakPeroranganNama.php?id=<?= $row["id"] ?>" class="btn btn-warning hapusStunting" style="display: inline-block; border-radius: 0px;"><img src="img/icon/view.png" class="iconTable2" alt="" style=""></a>
                        <a href="cetakStatistikAnakPerorangan.php?id_kia=<?= $row["id_kia"] ?>" target="blank()" class="btn btn-danger hapusStunting" style="display: inline-block; border-radius: 0px;"><img src="img/icon/pdfFormat.png" class="iconTable2" alt="" style=""></a>
                    </td>
                </tr>
                <?php $i++ ?>
            <?php endforeach; ?>
