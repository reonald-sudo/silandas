...
$sql = "SHOW TABLES";
$res = mysqli_query($dataMaster, $sql);

$num_tables_stunting = mysqli_num_rows($res);
...
<body>
    ...
    <div class="row no-gutter mt-5">
        ...
        <div class="col-md-10 pt-4 p-4 mt-3">
            <h3>
                <img src="img/icon/database_black.png" alt="" style="width: 27px; height: 27px; margin-bottom: 5px; margin-right: 5px;"> DATA MASTER
                <hr>
            </h3>
            ...
            <div class="row text-white">
                ...
                <!-- REKAP DATA KPM ANAK -->
                <div class="card ml-3" style="width: 25rem; margin-left: 12px; background-color: #198754;">
                    <div class="card-body">
                        <div class="card-body-icon" style="top: 60px;">
                            <img src="img/icon/book.png" style="width: 85px; opacity: 0.4;" alt="">
                        </div>
                        <h5 class="card-title">DATA REKAP KPM ANAK & IBU HAMIL</h5>
                        <div class="display-4" style="font-weight: bold;">
                            <?= $num_tables_stunting ?>
                        </div>
                        <a href="masterStunting.php" class="text-white noUnderline">
