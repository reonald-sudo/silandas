...
<body>
    ...
    <div class="row no-gutter mt-5">
        ...
        <div class="col-md-10 pt-4 p-4 mt-2" style="background-color: #f8f9fa;">
            <h3 class="heading-Page">
                <img src="img/icon/pdfFormatBlack.png" alt="" style="width: 27px; height: 27px; margin-bottom: 8px; margin-right: 5px;">LAPORAN SURAT PERNYATAAN KPM ANAK
                    ...
                    <?php foreach ($stunting as $row) : ?>
                        <tr align="center" class="font-Form-Input">
                            ...
                            <td>
                                ...
                                <img src="img/gif/loading.gif" alt="" style="width: 65px; height: 55px; z-index: -1; right: 100px; top: 100px; position: fixed; display: none;" id="loading">
                            </td>
                        </tr>
    ...
    <script src="js/laporanKpmAnak.js"></script>
</body>
