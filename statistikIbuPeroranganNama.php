...
$detailGrafikHamil = detailGrafikStuntingNama("SELECT * FROM grafik_perorangan_hamil WHERE id = '$id'");
...
<body style="background-color: #F8F9FA;">
        ...
        <table class="table table-bordered" style="border: 1px solid transparent; margin:0px; padding:0px;">
            ...
            <tr class="font-Form-Input">
                <td style="padding: 0px; padding-top: 8px;">
                    ...
                    <a href="statistikIbuPerorangan.php" class="btn btn-sm btn-primary mb-2" style="border-radius: 0px; background-color: #334b49; border: 1px solid #334b49;"><img src="img/icon/undo-white.png" alt="" class="iconTable" style="margin-right: 5px;">Kembali</a>
                </td>
            </tr>
        </table>
    </form>
    ...
    <div class="container" align="center" style="padding-top: 15px; padding-bottom: 10px; color:#4A5568">
        <h4 class="font-Form"><?= $detailGrafikHamil["nama"] ?></h4>
    </div>
    ...
    <script>
        const data = {
            ...
            datasets: [{
                    ...
                    data: [<?= $detailGrafikHamil["p_jan"] ?>,
                        <?= $detailGrafikHamil["p_feb"] ?>,
                        <?= $detailGrafikHamil["p_mar"] ?>,
                        <?= $detailGrafikHamil["p_apr"] ?>,
                        <?= $detailGrafikHamil["p_mei"] ?>,
                        <?= $detailGrafikHamil["p_jun"] ?>,
                        <?= $detailGrafikHamil["p_jul"] ?>,
                        <?= $detailGrafikHamil["p_agu"] ?>,
                        <?= $detailGrafikHamil["p_sep"] ?>,
                        <?= $detailGrafikHamil["p_okt"] ?>,
                        <?= $detailGrafikHamil["p_nov"] ?>,
                        <?= $detailGrafikHamil["p_des"] ?>
                    ],
