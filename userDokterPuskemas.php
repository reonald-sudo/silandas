...
$user = query("SELECT * FROM dokter LIMIT $awalData,$jumlahDataTampil")
    ...
    <div class="row no-gutter mt-5">
        ...
        <div class="col-md-10 pt-4 p-4 mt-3" style="background-color: #f8f9fa;">
            <h3 class="heading-Page">
                <img src="img/icon/stethoscope.png" alt="" style="width: 27px; height: 27px; margin-bottom: 8px; margin-right: 5px;"> DOKTER PUSKESMAS SUNGAI LANDAS
            ...
            <form action="" method="POST">
                <table class="table table-bordered" style="border: 1px solid transparent; margin:0px; padding:0px;">
                    ...
                    <tr>
                        ...
                        <td style="padding: 0px; padding-top: 8px; width: 71%;">
                            <a href="dashboardDokter.php" class="btn btn-primary mb-2 font-Form-Input" style="border-radius: 0px;"><img src="img/icon/plus-sign.png" alt="" class="iconTable" style="margin-right: 5px; height: 12px; width: 12px;">Tambah Data</a>
                        </td>
                ...
                <table class="table table-sm table-striped mb-3" style="border: 1px solid #DEE2E6; margin:0px;" cellspacing="0" cellpadding="5">
                    ...
                    <?php foreach ($user as $row) : ?>
                        <tr align="center" class="font-Form-Input">
                            ...
                            <td><?= $row["no_telp"] ?></td>
                            <td>
                                <a href="hapusUser.php?id= <?= $row["nip"] ?>" class="btn btn-danger hapus" style="font-family: 'Manrope', sans-serif; border-radius: 0px; border: 1px #dc3545;"><img src="img/icon/trashWhite.png" alt="" class="iconTable2"></a>

                                <a href="editUser.php?id= <?= $row["nip"] ?>" class="btn btn-info" style="font-family: 'Manrope', sans-serif; border-radius: 0px;  background-color: #FFC900; border: 1px #004f6e;" id="tombol_detail"><img src="img/icon/editing_white.png" alt="Detail" class="iconTable" align="center"></a>
                            </td>
                        </tr>
                        <?php $i++ ?>
                    <?php endforeach; ?>
