...
$editPetugas = editPetugas("SELECT * FROM petugas WHERE id_petugas = $id");
    ...
    <div class="row no-gutter mt-5">
        ...
        <div class="col-md-10 pt-4 p-4 mt-2" style="background-color: #f8f9fa;">
            <h3 class="heading-Page">
                <img src="img/icon/officer_black.png" alt="" style="width: 27px; height: 27px; margin-bottom: 5px; margin-right: 5px; "> DATA PETUGAS > EDIT DATA PETUGAS : <?= $editPetugas['nama'] ?>
            ...
            <form action="" method="POST">
                ...
                <table class="table table-sm table-bordered mb-2" style="margin:0px; padding: 0px; border: 1px solid transparent;">
                    ...
                    <td style="width: 14.8%; padding: 0px; margin-bottom: 5px;">
                        <a href="petugas.php" class="btn btn-primary font-Form-Input" style="border-radius: 0px; margin-top: -5px;"><img src="img/icon/left-arrow.png" class="iconTable" style="margin-right: 5px;" alt="">
                            Kembali
                        </a>
                    </td>
                    </tr>
                ...
                <div class="container shadow-Tambah-User">
                    ...
                    <div class="mb-3 row mt-3 id">
                        <label for="staticEmail" class="col-sm-4 col-form-label mt-3 font-Form">ID Petugas</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control mt-3 font-Form-Input" name="id" id="id" value="<?= $editPetugas['id_petugas'] ?>" readonly>
                        </div>
                    </div>
                    <!-- nama -->
                    <div class="mb-3 row mt-3">
                        <label for="staticEmail" class="col-sm-4 col-form-label font-Form">Nama</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control font-Form-Input" name="nama" id="nama" value="<?= $editPetugas['nama'] ?>">
                        </div>
                    </div>
                    <!-- jabatan -->
                    <div class="mb-3 row">
                        <label for="staticEmail" class="col-sm-4 col-form-label font-Form">Jabatan</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control font-Form-Input" name="jabatan" id="jabatan" value="<?= $editPetugas['jabatan'] ?>" readonly>
                        </div>
                    </div>
    ...
    <script>
        $('.batal').on('click', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.location.href = 'editPetugas.php?id= <?= $editPetugas['id_petugas']  ?>';
                }
            })
        });
    </script>
